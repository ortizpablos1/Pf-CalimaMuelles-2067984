...
class Productos extends Conexion
{
    ...
    {
        $file_path = null;
        $table = $this->db->prepare("SELECT nombre_producto,codigo,descripcion,precio,estado,cantidad,id_categoria,imagen FROM productos, imagenesproductos WHERE imagenesproductos.id_productos=productos.id_productos
        ");
        $table->execute();
        while ($result = $table->fetch()) {
            $file_path[] = $result;
